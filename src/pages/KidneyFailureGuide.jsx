...
const KidneyFailureGuide = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ['overview', 'symptoms', 'causes', 'diagnosis', 'treatment', 'prevention'];
  ...
  const diagnosisData = [
    {
      title: "Blood Tests",
      description: "Measures Creatinine and Urea. A key indicator is the Glomerular Filtration Rate (GFR).",
      keyPoint: "GFR: Indicates kidney filtering ability.",
      icon: "🩸",
      tests: ["Serum Creatinine", "Blood Urea Nitrogen", "GFR Calculation", "Electrolytes"]
    },
    {
      title: "Urine Tests",
      description: "Checks for protein (albuminuria) and blood in the urine, which are signs of kidney damage.",
      keyPoint: "Albuminuria: Protein in urine.",
      icon: "💧",
      tests: ["Urinalysis", "Protein/Creatinine Ratio", "Microalbumin Test", "24-hour Urine Collection"]
    },
    {
      title: "Imaging & Biopsy",
      description: "Ultrasound checks kidney size and structure. A biopsy may be used to confirm the type of kidney disease.",
  ...
  const treatmentsData = [
    {
      ...
      icon: "💉",
      benefits: ["Direct blood filtration", "Immediate waste removal", "Supervised medical care"]
    },
    {
      ...
      location: "Home",
      icon: "🔄",
      benefits: ["More flexible schedule", "Better mobility", "No vascular access needed"]
    },
    {
      ...
      location: "Hospital",
      icon: "🏥",
      benefits: ["Best quality of life", "No dialysis needed", "Normal kidney function"]
    }
  ];
  ...
  const preventionTips = [
    {
      ...
      tips: ["Keep below 140/90 mmHg", "Monitor regularly", "Take prescribed medications"],
      icon: "📊"
    },
    {
      title: "Blood Sugar Management",
      tips: ["Maintain HbA1c < 7%", "Regular glucose monitoring", "Follow diabetic diet"],
      icon: "📈"
    },
    {
      title: "Healthy Diet",
      tips: ["Low sodium intake", "Limit processed foods", "Adequate hydration"],
      icon: "🥗"
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-blue-50">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-green-600/20 backdrop-blur-sm mb-6">
              ...
              <span className="text-green-200 text-sm font-medium">COMPREHENSIVE GUIDE</span>
            </div>
            ...
            <p className="text-xl text-green-100 max-w-3xl mx-auto mb-10 leading-relaxed">
              Understanding symptoms, causes, diagnosis, and holistic treatment options for optimal kidney health.
            </p>
            
            <div className="flex flex-wrap justify-center gap-4">
              <button onClick={() => scrollToSection('symptoms')} className="px-6 py-3 bg-white text-green-800 font-semibold rounded-lg hover:bg-green-50 transition-all duration-300">
                Recognize Symptoms
              </button>
              <button onClick={() => scrollToSection('prevention')} className="px-6 py-3 border-2 border-white text-white font-semibold rounded-lg hover:bg-white/10 transition-all duration-300">
                Prevention Tips
              </button>
            </div>
          </motion.div>
      ...
      <div className="sticky top-0 z-40 bg-white/95 backdrop-blur-sm border-b border-gray-200 py-3">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap justify-center gap-2">
            {['overview', 'symptoms', 'causes', 'diagnosis', 'treatment', 'prevention'].map((section) => (
              <button
                key={section}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-6">
                Kidney failure, also known as renal failure, occurs when one or both kidneys lose their ability to function effectively. This condition can develop suddenly (acute) or gradually over time (chronic).
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-gray-700">Filters 120-150 quarts of blood daily</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 bg-green-600 rounded-full"></div>
                  </div>
                  <p className="text-gray-700">Produces 1-2 quarts of urine per day</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 bg-green-600 rounded-full"></div>
                  </div>
                  <p className="text-gray-700">Regulates blood pressure and electrolyte balance</p>
                </div>
              </div>
            </motion.div>
              ...
              <div className="grid grid-cols-2 gap-4 mt-8">
                {kidneyFacts.map((fact, index) => (
                  <div key={index} className="bg-green-50 p-4 rounded-lg text-center">
                    <div className="text-2xl font-bold text-green-700">{fact.stat}</div>
                    <div className="text-sm font-semibold text-gray-800">{fact.label}</div>
                    <div className="text-xs text-gray-600 mt-1">{fact.description}</div>
                  </div>
                ))}
              </div>
            </motion.div>
      ...
      {/* Symptoms Section */}
      <section id="symptoms" className="py-20 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Kidney disease often progresses silently. Recognizing symptoms early can lead to timely intervention.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900">Early Stage Symptoms</h3>
              </div>
            ...
            >
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900">Advanced Stage Symptoms</h3>
              </div>
              <div className="space-y-3">
            ...
            {causesData.map((cause, index) => (
              ...
              >
                <div className="text-center mb-4">
                  <div className="text-4xl font-bold text-green-700 mb-2">{cause.percentage}</div>
                  <div className="text-lg font-semibold text-gray-900">{cause.title}</div>
                </div>
                <p className="text-sm text-gray-600 text-center">{cause.description}</p>
      ...
      {/* Diagnosis Section */}
      <section id="diagnosis" className="py-20 bg-gradient-to-b from-green-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="inline-block px-4 py-1 bg-blue-100 text-blue-800 rounded-full text-sm font-semibold mb-4">
              DIAGNOSTIC PROCESS
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Early detection through routine tests is vital for slowing the progression of kidney disease.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {diagnosisData.map((item, index) => (
              ...
              >
                ...
                <p className="text-sm font-semibold text-green-700 mb-4">{item.keyPoint}</p>
                
                <div className="space-y-2">
                  {item.tests.map((test, testIndex) => (
                    <div key={testIndex} className="flex items-center text-sm text-gray-600">
      ...
      {/* Treatment Options */}
      <section id="treatment" className="py-20 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="inline-block px-4 py-1 bg-blue-100 text-blue-800 rounded-full text-sm font-semibold mb-4">
              TREATMENT OPTIONS
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {treatmentsData.map((treatment, index) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-4">{treatment.type}</h3>
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Combining traditional herbal wisdom with modern research to support kidney health naturally.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white rounded-xl p-6 shadow-md">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-bold text-gray-900">Crystomin Tablet</h3>
                </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-md">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-bold text-gray-900">Renal Support Formula</h3>
                </div>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-center text-gray-600">
                    <svg className="w-4 h-4 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
          ...
          >
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="md:w-2/3 md:pl-8">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Pooja Chalise</h3>
                <p className="text-green-700 font-semibold mb-3">Pharmacist, QC Department</p>
                <p className="text-gray-600 mb-4">
                  With specialized training in nephrology and herbal medicine, Pooja is dedicated to educating patients about kidney health and holistic treatment approaches. She combines traditional Ayurvedic knowledge with modern medical science.
                </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-green-200 mb-10 max-w-2xl mx-auto leading-relaxed">
              Our experts at Siddha Formulation can help assess your risk and recommend personalized kidney support solutions based on your specific needs.
            </p>
